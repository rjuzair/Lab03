...
#' @description The algorithm calculates the shortest path of a graph \code{wiki_graph} with an initial node.
#' @source See more at: \url{https://en.wikipedia.org/wiki/Euclidean_algorithm}
